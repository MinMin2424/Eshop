<?php
     ...
     */
    $html = file_get_contents('zabava.php');
    $dom = new DOMDocument();
    @$dom -> loadHTML($html);
     ...
     */
    $zabavaData = file_get_contents('../../data-users-products/zabava-data/zabava.json');
    $zabavaJson = json_decode($zabavaData, true);
...
<body>
    ...
    <div class="container">
        ...
        <?php 
            ...
            // Získání aktuální stránky nebo nastavení výchozí hodnoty na 1.
            $currentPage = isset($_GET["page"]) ? (int)$_GET["page"] : 1;
            $itemsPerPage = 12; // Počet položek na stránku.
            $totalItems = count($zabavaJson); // Celkový počet položek.
            $totalPages = ceil($totalItems / $itemsPerPage); // Celkový počet stránek na základě počtu položek na stránku.

            // Určení začátku a konce položek na aktuální stránce.
            $start = ($currentPage - 1) * $itemsPerPage;
            $end = $start + $itemsPerPage;

            // Filtrování data na základě aktuální stránky a počtu položek na stránku.
            $filteredData = array_slice($zabavaJson, $start, $itemsPerPage);

            // Procházení filtrovaná data a generování HTML pro zobrazení položek.
            foreach ($filteredData as $item) {

                // Určení pohlaví uživatele pro zobrazení správné ikony.
                $gender = "";
                ...
                // Vytváření HTML pro zobrazení jednotlivé položky.
    ...
    <div class='page-container'>
            <?php
                // Vytváření odkazy na stránky na základě celkového počtu stránek.
                for ($page = 1; $page <= $totalPages; $page++) {
                    echo "<span class='page'><a href='zabava.php?page=$page'>$page</a></span>";
                }
            ?>
    </div>
