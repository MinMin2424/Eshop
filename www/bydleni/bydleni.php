<?php
     ...
     */
    $html = file_get_contents('bydleni.php');
    $dom = new DOMDocument();
    @$dom -> loadHTML($html);
     ...
     */
    $data = file_get_contents('../../data-users-products/bydleni-data/bydleni.json');
    ...
    <header class="header-main">
        ...
        <nav>
            ...
            <ul>
                ...
                <li><a href="bydleni.php">Bydlení</a></li>
    ...
    <div class='page-container'>
            <?php
                ...
                for ($page = 1; $page <= $totalPages; $page++) {
                    echo "<span class='page'><a href='bydleni.php?page=$page'>$page</a></span>";
                }
            ?>
    </div>
