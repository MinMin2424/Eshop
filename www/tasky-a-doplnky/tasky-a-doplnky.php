<?php
     ...
     */
    $html = file_get_contents('tasky-a-doplnky.php');
    $dom = new DOMDocument();
    @$dom -> loadHTML($html);
...
<head>
    ...
    <title>Manie - Tašky a doplňky</title>
    ...
    <header class="header-main">
        ...
        <nav>
            ...
            <ul>
                ...
                <li><a href="tasky-a-doplnky.php">Tašky a doplňky</a></li>
    ...
    <div class='page-container'>
            <?php
                ...
                for ($page = 1; $page <= $totalPages; $page++) {
                    echo "<span class='page'><a href='tasky-a-doplnky.php?page=$page'>$page</a></span>";
                }
            ?>
    </div>
