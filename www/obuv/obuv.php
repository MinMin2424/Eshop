<?php
     ...
     */
    $html = file_get_contents('obuv.php');
    $dom = new DOMDocument();
    @$dom -> loadHTML($html);
     ...
     */
    $data = file_get_contents('../../data-users-products/obuv-data/obuv.json');
    ...
    <div class='page-container'>
            <?php
                ...
                for ($page = 1; $page <= $totalPages; $page++) {
                    echo "<span class='page'><a href='obuv.php?page=$page'>$page</a></span>";
                }
            ?>
    </div>
