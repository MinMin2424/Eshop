<?php
     ...
     */
    $html = file_get_contents('deti.php');
    $dom = new DOMDocument();
    @$dom -> loadHTML($html);
     ...
     */
    $data = file_get_contents('../../data-users-products/deti-data/deti.json');
            ...
            <?php
             // Vytváření odkazy na stránky na základě celkového počtu stránek.
                for ($page = 1; $page <= $totalPages; $page++) {
                    echo "<span class='page'><a href='deti.php?page=$page'>$page</a></span>";
                }
            ?>
    </div>
