<?php
     ...
     */
    $html = file_get_contents('mazlicci.php');
    $dom = new DOMDocument();
    @$dom -> loadHTML($html);
     ...
     */
    $data = file_get_contents('../../data-users-products/mazlicci-data/mazlicci.json');
...
<body>
    ...
    <header class="header-main">
        ...
        <nav>
            ...
            <ul>
                ...
                <li><a href="mazlicci.php">Mazlíčci</a></li>
    ...
    <div class="container">
        ...
        <?php 
            ...
            $totalItems = count($json); // Celkový počet položek.
    ...
    <div class='page-container'>
            <?php
                ...
                for ($page = 1; $page <= $totalPages; $page++) {
                    echo "<span class='page'><a href='mazlicci.php?page=$page'>$page</a></span>";
                }
            ?>
    </div>
